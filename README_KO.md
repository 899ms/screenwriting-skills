...
이것은 고민 끝에 내린 결정이며, 처음의 결정은 아니었습니다. 한때 영어판이 있었습니다. 20개 스킬을 모두 번역한 병렬 플러그인 `screenwriting-en`으로, [#3](https://github.com/jtydhr88/screenwriting-skills/issues/3)에서 제안되고, 구현되고, 병합되었습니다. 그리고 삭제되었습니다. 그것을 물리친 논거는 다른 모든 언어에도 똑같이 적용됩니다. 중국어를 읽지 못하는 독자에게 번역된 트리가 필요하다면 영어를 읽지 못하는 독자에게도 필요하고, 다음은 일본어, 그다음은 한국어, 프랑스어, 러시아어입니다. 5개 언어면 230개 파일이 제각기 어긋나기 시작하고, 어느 것이 낡았는지 알려주는 장치는 아무것도 없습니다. 번역 작업 자체는 큰 품이 들지 않습니다. 진짜 비용은 **한 번 포크하고 나면 두 번째를 거절할 원칙적 근거가 사라진다**는 점입니다.
...
스킬 자체는 MIT 라이선스입니다([LICENSE](LICENSE)). 인용문은 MIT 적용 대상이 아니며 원저자와 역자, 출판사에 귀속됩니다([NOTICE](NOTICE)).
